...
class ImdbDataset(Dataset):
    def __init__(self, train=True, sequence_max_len=100):
        ...
        if not os.path.exists("./data/download/train/pos"):
            unzip_file("./data/train.zip", "./data/download")
        if not os.path.exists("./data/download/test/pos"):
...
def tokenlize(sentence):
    ...
    fileters = [r'!', r'"', r'#', r'$', r'%', r'&', r'\(', r'\)', r'\*', r'\+', r',', r'-', r'\.', r'/', r':', r';', r'<', r'=', r'>',
                 r'\?', r'@', r'\[', r'\\', r'\]', r'^', r'_', r'`', r'\{', r'\|', r'\}', r'~', r'\t', r'\n', r'\x97', r'\x96', r'”', r'“']
